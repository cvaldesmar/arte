...
class VanGoghMuseum:
    ...
    def vanGoghMuseumDataExport(self, filename):
        testDriver = self.createNewWebdriver(0, 0, little=0)
        testDriver.get("https://www.vangoghmuseum.nl/en/search/collection?q=&pagesize=4165")
        pageSize = 4165
        # testDriver.get("https://www.vangoghmuseum.nl/en/search/collection?q=&artist=Vincent%20van%20Gogh&pagesize=1439")
        # pageSize = 1439
        # testDriver.get("https://www.vangoghmuseum.nl/en/search/collection?q=&artist=Vincent%20van%20Gogh&type=letter&pagesize=79")
        # pageSize = 79
        time.sleep(2)
    ...
    def vanGoghMuseumExploration(self, filename):
        testDriver = self.createNewWebdriver(0, 0, little=0)
